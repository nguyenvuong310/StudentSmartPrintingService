              ...
              <div class="inline-block min-w-full py-2 pt-10 sm:px-6 lg:px-8">
                <div class="overflow-hidden rounded-lg shadow">
                  <div class="flex w-full border-2 border-b-black bg-white">
                    <div class="text-black-600 w-full px-7 py-5 text-2xl font-bold">
                      Quản lý sinh viên
                    </div>
                      ...
                      >
                        <li class="me-2" role="presentation">
                          <button
                            class={
                              toggle == 1 || toggle == 3
                                ? "ml-1 mt-1 flex flex-row rounded-t-lg bg-white px-1 py-1 text-xl font-medium text-black"
                                : "ml-1 mt-1 flex flex-row rounded-t-lg px-1 py-1 text-xl font-medium text-white focus:bg-white focus:text-black"
                            }
                        ...
                        <li class="me-2" role="presentation">
                          <button
                            class={
                              toggle == 2 || toggle == 4
                                ? "ml-1 mt-1 flex flex-row rounded-t-lg bg-white px-1 py-1 text-xl font-medium text-black text-black"
                                : "ml-1 mt-1 flex flex-row rounded-t-lg px-1 py-1 text-xl font-medium text-white focus:bg-white focus:text-black"
                            }
                          ...
                          listUser.map((user, index) => {
                            return (
                              <tr className="odd:bg-blue-50 even:bg-white">
                                ...
                                <td class="whitespace-nowrap px-7 py-4 text-center font-light text-gray-900">
                                  {user.numpage - user.numpageused}
                                </td>
                                <td class="whitespace-nowrap px-7 py-4 text-center text-lg font-light text-gray-900">
                                  <button
                                    href="#"
                                    class="border-4 border-[#c4c4c4] bg-red-500 px-3 py-1 text-sm font-thin text-white hover:shadow"
                                    onClick={() =>
                                      HandleBlockUser(user.userid, index)
                                    }
                                  >
                                    CẤM
                                  </button>
                  ...
                  <div class={toggle == 3 ? "flex" : "hidden"}>
                    <table class="round-md w-full table-auto divide-gray-200 dark:divide-gray-700">
                      ...
                      <tbody className="mt-1">
                        {listUserBySearch &&
                          listUserBySearch.map((user, index) => {
                            return (
                              <tr className="odd:bg-blue-50 even:bg-white">
                                <td class="whitespace-nowrap px-7 py-4 text-lg font-light text-gray-900">
                                  {user.userid}
                            ...
                            return (
                              <tr className="odd:bg-blue-50 even:bg-white">
                                ...
                                <td class="whitespace-nowrap px-7 py-4 text-center text-lg font-light text-gray-900">
                                  <button
                                    href="#"
                                    class="border-4 border-[#c4c4c4] bg-blue-300 px-3 py-1 text-sm font-thin text-white hover:shadow"
                                    onClick={() =>
                                      HandleDeleteBlockUser(user.userid, index)
                                    }
                                  >
                                    GỠ CẤM
                                  </button>
                  ...
                  <div class={toggle == 4 ? "flex" : "hidden"}>
                    <table class="round-md w-full table-auto divide-gray-200 dark:divide-gray-700">
                      ...
                      <tbody className="mt-1">
                        {listBlockedUserBySearch &&
                          listBlockedUserBySearch.map((user, index) => {
                            return (
                              <tr className="odd:bg-blue-50 even:bg-white">
                                <td class="whitespace-nowrap px-7 py-4 text-lg font-light text-gray-900">
                                  {user.userid}
