    ...
    <nav class="bg-white dark:bg-gray-900 sticky w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pt-4 pl-4 pr-4">
        ...
        <div class="flex flex-row items-center justify-center sm:items-stretch sm:justify-start">
          <div class=" bottom-5 left-0 py-2  sm:hidden block ">
          ...
          <Card className=" mx-auto ">
            <CardBody >
              <Typography variant="small"  >
                ...
                <div onClick={() => test(1)} class="flex py-2 pl-1 gap-2 hover:bg-blue-200 hover:text-white text-base font-medium text-gray-700 rounded-md">
                ...
                <hr className="my-2 border-blue-gray-50" />
                <div onClick={() => test(2)} class="flex py-2 pl-1 gap-2 hover:bg-blue-200 hover:text-white text-base font-medium text-gray-700 rounded-md">
