    ...
    <nav class="bg-white shadow-xl">
      <div class="mx-auto max-w-7xl px-2 py-3 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
          ...
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:flex hidden sm:static sm:inset-auto sm:ml-6 sm:pr-0">
      ...
      <div class="sm:hidden flex">
        <Collapse open={open}>
          <Card className=" mx-auto ">
            <CardBody>
              <Typography variant="small" class="text-gray-700 hover:bg-blue-200 hover:text-white block rounded-md px-3 py-1 text-base font-medium" onClick={handleLogout} >
                Đăng xuất
              </Typography>
            </CardBody>
          </Card>
