...
const Footer = () => {
  return (
    <footer class="relative bg-blueGray-200 pt-5 bg-blue-fill">
            ...
            <div class="flex flex-wrap items-top mb-6">
              <div class="w-full lg:w-4/12 px-4 ml-auto">
                ...
                <ul class="list-unstyled">
                  <li>
                    <a class="text-white font-semibold block pb-2 text-sm" href="">Về chúng tôi</a>
                  </li>
                  <li>
                    <a class="text-white  font-semibold block pb-2 text-sm" href="">Điều khoản dịch vụ</a>
                  </li>
                </ul>
              </div>
              <div class="w-full lg:w-5/12 px-4 hidden sm:ml-6 sm:block">
                ...
                <ul class="list-unstyled">
                  <li className="flex flex-row">
                    <DevicePhoneMobileIcon className="w-5 mr-1" color="white" />
                    <a class="text-white font-semibold block pb-2 pt-2 text-sm" href="">0986801203</a>
                  </li>
                  <li className=" flex flex-row">
                    <InboxArrowDownIcon className="w-5 mr-1" color="white" />
                    <a class="text-white font-semibold block pb-2 pt-2 text-sm" href="">baosranger@hcmut.edu.vn</a>
                  </li>
                  <li className=" flex flex-row">
                    <HomeModernIcon className="w-5 mr-1" color="white" />
                    <a class="text-white font-semibold block pb-2 text-sm" href="">meet-ewa</a>
                  </li>
                </ul>
              </div>
            </div>
