...
const Header = ({ role }) => {
  ...
  return (
    <nav class="bg-white shadow-xl">
        ...
        <div class="relative flex h-16 items-center justify-between">
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="flex flex-col space-x-4 px-3 py-2">
              ...
              <Typography variant="small" className="hidden sm:ml-6 sm:block">
      ...
      <div class="flex sm:hidden" id="mobile-menu">
        <Collapse open={open}>
          <Card className=" mx-auto ">
            <CardBody>
              <Typography>
                <a
                  href="login"
                  class="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-blue-200 hover:text-white"
                >
                  Đăng nhập
                </a>
              </Typography>
