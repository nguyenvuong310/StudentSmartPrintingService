...
export default function UploadModal({ isOpen, toggle }) {
      ...
      {showModal ? (
        <>
          <div class="fixed inset-0 z-50 flex justify-center outline-none focus:outline-none ">
            <div class="extraOutline bg-whtie relative m-auto w-[40rem] rounded-lg bg-[#ABD7EF] p-4">
              <div className="absolute right-0 top-0 m-2 h-6 w-6 rounded-full border-2 border-blue-700">
                <button
                  className="pl-[5.5px]"
                  type="button"
                  onClick={() => handleClose()}
              ...
              <div className="my-5 grid grid-cols-2 gap-6">
                ...
                <div>
                  <div className="mb-2 font-bold">Chọn môn học của tệp</div>
                  <CreatableSelect
                ...
                <div>
                  <div className="mb-2 font-bold">Nhập tên tệp</div>
              ...
              <div class="file_upload relative mb-9 rounded-lg border-4 border-dotted border-gray-300 bg-white p-5">
                {!uploaded && (
                  <svg
                ...
                <div class="input_field mx-auto flex w-max flex-col text-center">
                  ...
                  <label>
                    ...
                    />
                    <div class="text cursor-pointer rounded border border-gray-300 bg-indigo-600 p-1 px-3 font-semibold text-white hover:bg-indigo-500">
                      Tải lên từ máy tính
                    </div>
                  </label>
                </div>
              ...
              <button
                ...
                type="button"
                className="absolute bottom-0 right-0 m-2 w-20 rounded-xl bg-[#658DF1] p-1 text-white"
              >
                Tải lên
              </button>
            </div>
