...
import { Typography, Collapse, Card, CardBody } from "@material-tailwind/react";
import {
  LanguageIcon,
      ...
      <div class="mx-auto max-w-7xl px-2 py-3 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div class="absolute bottom-5 left-0 block  py-2 sm:hidden ">
              <button
                onClick={toggleOpen}
                type="button"
            ...
            <CardBody>
              <Typography variant="small">
                ...
                <div class="block flex gap-2 rounded-md py-2 pl-1 text-base font-medium text-gray-700 hover:bg-blue-200 hover:text-white">
                  ...
                  <div onClick="#">Quản lí sinh viên</div>
                </div>
                <hr className="my-2 border-blue-gray-50" />
                <div class="block flex gap-2 rounded-md py-2 pl-1 text-base font-medium text-gray-700 hover:bg-blue-200 hover:text-white">
                  <PrinterIcon className="w-5" />
                  <div onClick="#">Quản lí máy in</div>
                </div>
                <hr className="my-2 border-blue-gray-50" />
                <div class="block flex gap-2 rounded-md py-2 pl-1 text-base font-medium text-gray-700 hover:bg-blue-200 hover:text-white">
                  <ClockIcon className="w-5" />
                  <div onClick="#">Quản lí lịch sử in</div>
                </div>
                <hr className="my-2 border-blue-gray-50 " />
                <div class="block flex gap-2 rounded-md py-2 pl-1 text-base font-medium text-gray-700 hover:bg-blue-200 hover:text-white">
