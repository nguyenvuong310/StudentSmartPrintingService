...
const PrivateStorage = (props) => {
    ...
    const handleIndex = (index) => {
        ...
        const element = (
            <div class="grid md:grid-cols-5 grid-cols-2 grid-flow-row  gap-x-[4rem] gap-y-[2rem] p-10">
                {listdoc.slice((index - 1) * 10, (index * 10)).map((doc, index) =>
                (
                    < StudentFileCard
                        doc={doc}
    ...
    return (
        <>
            <div className="flex  flex-col min-h-[750px] w-[90%] self-center bg-blue-200 mt-5 rounded-xl">
