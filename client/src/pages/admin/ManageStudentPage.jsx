                            ...
                            <div class="overflow-hidden shadow rounded-lg">
                                ...
                                <div class="bg-[#8289ad] border border-b-black flex w-full">
                                    ...
                                    tab">
                                            ...
                                            <li class="me-2" role="presentation">
                                                <button class={toggle == 2 ? "flex flex-row font-medium px-1 py-1 mt-1 ml-1 text-black bg-white rounded-t-lg text-black text-xl" : "flex flex-row font-medium px-1 py-1 mt-1 ml-1 text-white focus:bg-white rounded-t-lg focus:text-black text-xl"} onClick={() => updateToggle(2)}>
                                                    <a>Danh sách cấm</a>
                                                </button>
                                            </li>
                                        </ul>
