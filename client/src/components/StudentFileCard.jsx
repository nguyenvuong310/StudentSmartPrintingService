...
const StudentFolderCard = ({ numpPage, textFile, textSubject, textType, fileLink, filetoDown, filetoPrint }) => {

    return (
        <div class="w-[12rem] shadow rounded-lg  grid gap-2 bg-blue-600 ">
            <div class="h-[9.5rem] w-full border grid grid-cols-1 gap-4 justify-evenly p-5 mt-2 bg-cover bg-center
            bg-fileimg-fill " >
                ...
                <PrintingPage docUrl={filetoPrint} userNumPage={numpPage} />
            </div>
