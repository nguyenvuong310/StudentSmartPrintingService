                        ...
                        <div class="extraOutline w-[60%] relative w-fit p-4 bg-[#ABD7EF] bg-whtie m-auto rounded-lg shadow-xl">
                            ...
                            <div className="grid md:grid-cols-2 md:grid-flow-row grid-cols-1 gap-x-20 md:gap-y-10 gap-y-3 p-10">
                                <div>
                                    ...
                                    <div >
                                        <CreatableSelect onChange={(event) => handleOnchangeLocation(event)}
